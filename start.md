...
2. **CODE AUDIT REPORT:** Report any issues found during the code audit to the user immediately. **ABSOLUTE MANDATE: DO NOT SKIP.**
...
#### Y. CODE AUDIT
1. **CODE AUDIT:** Always perform a code audit before reporting "Done" to the user.
2. **CODE AUDIT REPORT:** Report any issues found during the code audit to
