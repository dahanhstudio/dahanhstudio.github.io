		...
		<div className="relative w-full max-w-2xl">
			...
			<div className="relative">
				...
				<Input
					...
					placeholder="Tìm kiếm công việc và tài liệu..."
				...
				<div className="absolute z-50 w-full mt-2 bg-card rounded-lg border shadow-lg max-h-96 overflow-y-auto">
					{loading && (
						<div className="p-4 text-center">
							<span className="text-muted-foreground">Đang tìm...</span>
						</div>
					)}

					{!loading && totalResults === 0 && (
						<div className="p-4 text-center">
							<span className="text-muted-foreground">Không tìm thấy kết quả cho "{query}"</span>
						</div>
					)}
