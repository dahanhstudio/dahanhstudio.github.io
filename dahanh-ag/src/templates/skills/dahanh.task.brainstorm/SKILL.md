...
**Announce at start:** "I'm using the dahanh.task.brainstorm skill to explore approaches."
...
```bash
dahanh task edit $ARGUMENTS -d "Updated based on brainstorm..."
```
