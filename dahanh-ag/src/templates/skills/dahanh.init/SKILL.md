...
**Announce at start:** "I'm using the dahanh.init skill to initialize this session."
...
dahanh doc "ARCHITECTURE" --plain --smart

# 3. Conventions (if exists)
dahanh doc "CONVENTIONS" --plain --smart
```
...
# High priority todos
dahanh task list --status todo --plain | head -20
```
