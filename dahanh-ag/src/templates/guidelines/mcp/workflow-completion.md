...
| Requirement | How |
|-------------|-----|
| All AC checked | CLI: `dahanh task edit <id> --check-ac N` |
| Notes added | CLI: `dahanh task edit <id> --notes "Summary"` |
...
dahanh task edit abc123 --notes $'## Summary
...
dahanh task edit abc123 --ac "Fix: description"
dahanh task edit abc123 --append-notes "Reopened: reason"
```
