...
dahanh task edit 35 -a "Criterion text"

# ✅ CORRECT (use --ac)
dahanh task edit 35 --ac "Criterion text"
```
...
| Problem | Solution |
|---------|----------|
| Set assignee to AC text | `dahanh task edit <id> -a @me` |
| Forgot to stop timer | `dahanh time add <id> <duration>` |
| Checked AC too early | `dahanh task edit <id> --uncheck-ac N` |
| Task not found | `dahanh task list --plain` |
