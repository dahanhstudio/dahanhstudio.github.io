...
const PROJECT_ROOT_DIR = ".dahanh";
const DOCS_DIR = ".dahanh/docs";

export class FileStore {
	public readonly projectRoot: string;
	private basePath: string; // .dahanh/
	private tasksPath: string; // .dahanh/tasks/
	private archivePath: string; // .dahanh/archive/
	private projectPath: string; // .dahanh/config.json
	private timeEntriesPath: string; // .dahanh/time-entries.json
	private versionStore: VersionStore;

	constructor(projectRoot: string) {
		this.projectRoot = projectRoot;
		this.basePath = join(projectRoot, PROJECT_ROOT_DIR);
