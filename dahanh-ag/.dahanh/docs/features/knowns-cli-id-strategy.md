---
title: Dạ Hành AG CLI - ID Strategy
createdAt: '2026-01-08T08:48:57.016Z'
updatedAt: '2026-01-09T07:46:23.699Z'
description: ID generation and collision handling for Dạ Hành AG CLI entities
tags:
  - cli
  - id
---
# Dạ Hành AG CLI - ID Strategy

> How IDs are generated and managed in Dạ Hành AG CLI
...
```bash
$ dahanh task add "Fix login bug"
Created task-a7f3k9

$ dahanh doc add "API Specification" -f api
...
$ dahanh task create "My Subtask" --parent 48
...
```bash
# ✅ Correct - use raw ID
dahanh task create "Subtask Title" --parent 48
dahanh task create "Subtask Title" --parent qkh5ne

# ❌ Wrong - do NOT prefix with "task-"
dahanh task create "Subtask Title" --parent task-48    # ERROR
dahanh task create "Subtask Title" --parent task-qkh5ne  # ERROR
```
...
$ dahanh task 48 --plain
# OR
$ dahanh task qkh5ne --plain
...
When using `dahanh task list --plain`, the output shows:
