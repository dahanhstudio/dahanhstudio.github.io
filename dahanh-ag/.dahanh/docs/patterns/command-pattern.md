...
The Command Pattern is the primary pattern used to build Dạ Hành AG CLI. Each command is an independent module that can be extended and tested separately.
