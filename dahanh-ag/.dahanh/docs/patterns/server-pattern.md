...
Dạ Hành AG server uses Express 5 + SSE (Server-Sent Events) to provide an API for the Web UI and real-time synchronization between clients.
...
| tasks | GET | `/api/tasks` | Xem danh sách việc |
...
- @doc/patterns/ui-pattern - React UI Pattern
