...
description: High-level overview of Dạ Hành AG architecture and how patterns connect
tags:
  - architecture
  - overview
---
...
Dạ Hành AG is a CLI-first knowledge layer and task management system for development teams. Designed to maintain persistent project context for AI assistance.

**Tagline**: "What your AI should have dahanh."
...
┌─────────────────────────────────────────────────────────────┐
│                   File System Layer                          │
│    .dahanh/tasks/ | .dahanh/docs/ | config.json | versions   │
└─────────────────────────────────────────────────────────────┘
```
...
FileStore.createTask()
       │
       ▼
Write to .dahanh/tasks/task-X.md
       │
       ▼
