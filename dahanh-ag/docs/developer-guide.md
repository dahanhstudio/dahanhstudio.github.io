# Dạ Hành AG Developer Guide

Technical documentation for contributors and developers building on Dạ Hành AG.

---

## Architecture Overview

Dạ Hành AG follows a layered architecture with CLI as the primary interface.
...
|------|---------|------|----------|
| cli | instruction | ~600 bytes | Minimal - tells AI to call `dahanh agents guideline` |
...
- CLI: `dahanh agents guideline`
- MCP: `mcp__dahanh__get_guideline({})`
...
```bash
# Clone repository
git clone https://github.com/dahanh-dev/dahanh.git
cd dahanh
